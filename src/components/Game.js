      ...
      render() {
        ...
        return(
          <View style={ styles.container }>
            <Text style={ styles.heading }>TargetSum</Text>
            ...
            <View style={ styles.randomContainer }>
              { this.randomNumbers.map((randomNumber, index) => 
                <RandomNumber 
                  ...
                  onPress={this.selecteNumber}
                />                
              )}
            </View>
            <Text> {gameStatus} </Text>
            <Text> Seconds Remaining: {this.state.remainingSeconds} </Text>
